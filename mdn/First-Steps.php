...
<div class="row">
    <div class="col-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" data-toggle="pill" href="#WhatisJavaScript">What is JavaScript?</a>
            <a class="nav-link" data-toggle="pill" href="#tu">What is JavaScript?</a>

        </div>
    </div>
    <div class="col-9">
        <div class="tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade active" id="WhatisJavaScript" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                ...
                <hr>
                <h3 class="text-info">Interpreted versus compiled code</h3>
                <ul>
